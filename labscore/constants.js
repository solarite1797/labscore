...
module.exports.AI_GPT_MODEL_CONFIG = {
  ...
  "replicate:replicate/alpaca-7b": { name: "Replicate alpaca-7b", icon: "replicate" },
  "replicate:stability-ai/stablelm-tuned-alpha-7b": { name: "Stability AI stablelm-tuned-alpha-7b", icon: "stability" },
...
module.exports.AI_GPT_MODELS = [
  ...
  { name: "Replicate alpaca-7b", value: "replicate:replicate/alpaca-7b" },
  { name: "Replicate stablelm-tuned-alpha-7b", value: "stability-ai/stablelm-tuned-alpha-7b" },
